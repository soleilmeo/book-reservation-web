...
;(function ($) {
    ...
    let NOTIFICATION_CONTAINER_LIST = []
    function Notification(props) {
        ...
        if (!this.$container.length) {
            ...
            const css = "#" + this.containerId + " {" +
                ...
                "#" + this.containerId + " {min-width: 0; max-width: 100%; width: 100%; right: 0;}" +
    ...
    Notification.prototype.showNotification = function () {
        ...
        NOTIFICATION_CONTAINER_LIST.push($notification);
        if (NOTIFICATION_CONTAINER_LIST.length > this.props.stackLimit) {
            if (NOTIFICATION_CONTAINER_LIST[0]) {
                NOTIFICATION_CONTAINER_LIST.shift().alert("close");
            }
        }
        ...
        if(this.props.duration) {
            setTimeout(function () {
                ...
                NOTIFICATION_CONTAINER_LIST = NOTIFICATION_CONTAINER_LIST.filter($notif => $notif !== $notification);
            }, this.props.duration)
        }
        return $notification
    }
